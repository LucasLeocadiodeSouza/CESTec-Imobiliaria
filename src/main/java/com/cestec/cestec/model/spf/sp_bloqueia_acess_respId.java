...
@NoArgsConstructor
@AllArgsConstructor
public class sp_bloqueia_acess_respId implements Serializable{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof sp_bloqueia_acess_respId)) return false;
        sp_bloqueia_acess_respId that = (sp_bloqueia_acess_respId) o;
