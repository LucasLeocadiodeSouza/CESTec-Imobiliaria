...
public class cri001c {
    ...
    public pcp_imovel salvarImovel(@RequestBody pcp_imovel imovel, @RequestParam(value = "codprop", required = false) Integer codprop) {
        return cri001s.salvarImovel(imovel, codprop);
    }
